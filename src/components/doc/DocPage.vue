      ...
      <div class="capability-map">
        ...
        <div class="cap-card cap-card-cf">
          ...
          <ul class="cap-list">
            ...
            <li><span class="cap-row-label">云端</span><span style="color:#d1d5db">云端 IDE · Duet 模式</span> <span style="font-size:10px;color:#f59e0b;background:#fef3c7;padding:1px 5px;border-radius:3px;font-weight:600">TODO</span></li>
